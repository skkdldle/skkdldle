...
//  UNUSED(color);
    ...
    for (int i = 0; i < height; i++) {
        ...
        DMA[3].cnt = width | DMA_DESTINATION_INCREMENT | DMA_SOURCE_FIXED | DMA_NOW | DMA_16 | DMA_ON;
    }
}
...
//  UNUSED(image);
    ...
    DMA[3].cnt = (WIDTH * HEIGHT) | DMA_DESTINATION_INCREMENT | DMA_SOURCE_INCREMENT | DMA_NOW | DMA_16 | DMA_ON;
}
...
//  UNUSED(image);
    ...
    for (int i = 0; i < height; i++) {
        ...
        DMA[3].dst = (videoBuffer + OFFSET(row + i, col, WIDTH));
        DMA[3].cnt = width | DMA_DESTINATION_INCREMENT | DMA_SOURCE_INCREMENT | DMA_NOW | DMA_16 | DMA_ON;
    }
}
...
//  UNUSED(color);
    ...
    DMA[3].src = &color;
    DMA[3].dst = videoBuffer;
    DMA[3].cnt = (WIDTH * HEIGHT) | DMA_DESTINATION_INCREMENT | DMA_SOURCE_FIXED | DMA_NOW | DMA_16 | DMA_ON;
}
